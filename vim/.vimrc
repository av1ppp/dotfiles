...
set colorcolumn=80								"вертикальная полоса после 80
...
"-----------------------------------------> Neocomplete <--
let g:neocomplete#enable_at_startup = 1			"автоматический запуск
set completeopt-=preview						"отключаем меню
